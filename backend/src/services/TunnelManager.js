...
class TunnelManager extends EventEmitter {
    ...
    closeTunnel(tunnelId, reason = 'Tunnel closed') {
        ...
        // Calculate tunnel duration for metrics
        const duration = Date.now() - tunnel.createdAt;

        // Emit event (tunnel, duration, reason)
        this.emit('tunnel:closed', tunnel, duration, reason);
    }
